package jp.giogio.individualjojoline.widget;
...
public class CoverFlowImageAdapter extends BaseAdapter {
	 ...
	 * 元画像と反射エフェクト間の距離。
	 */
	private static int REFLECTION_GAP = 1;
...
//		int    destHeight = height + height / 4;
//		Bitmap effect     = Bitmap.createBitmap( src, 0, height / 4, width, height / 4, matrix, false );
//		Bitmap dest       = Bitmap.createBitmap( width, destHeight, Config.ARGB_4444 );
////		Bitmap dest       = Bitmap.createBitmap( width, destHeight,Config.RGB_565);
