...
public interface IMountServiceListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements 
        ...
        private static class Proxy implements  IMountServiceListener {
             ...
             */
            public void onUsbMassStorageConnectionChanged(
                ...
                try {
                    ...
                    mRemote
                            .transact(
                                    Stub.TRANSACTION_onUsbMassStorageConnectionChanged,
                                    _data, _reply, 0);
             ...
             */
            public void onStorageStateChanged(String path,
                ...
                try {
                    ...
                    mRemote.transact(
                            Stub.TRANSACTION_onStorageStateChanged,
                            _data, _reply, 0);
                    _reply.readException();
                } finally {
                    _reply.recycle();
