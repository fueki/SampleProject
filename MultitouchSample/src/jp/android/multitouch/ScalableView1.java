...
public class ScalableView1 extends ImageView implements OnTouchListener{
	private static final String TAG = "ScalableView1";
	...
	public ScalableView1(Context context) {
		this(context, null, 0);
	}

//	public ScalableView1(Context context, AttributeSet attrs) {
//		this(context, attrs, 0);
//	}

	public ScalableView1(Context context, AttributeSet attrs, int defStyle) {
